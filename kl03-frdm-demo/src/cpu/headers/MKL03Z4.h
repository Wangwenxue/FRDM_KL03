...
**
**     Reference manual:    KL03RM, Rev.0, Oct 2013
**     Version:             rev. 1.0, 2013-10-21
**
**     Abstract:
...
typedef enum {
  ...
  INT_Reserved43               = 43,               /**< Reserved interrupt 43 */
...
typedef struct I2C_MemMap {
  ...
  uint8_t S;                                       /**< I2C Status register 1, offset: 0x3 */
...
#define I2C0_S1                                  I2C_S_REG(I2C0_BASE_PTR)
...
typedef struct MCG_MemMap {
  ...
  uint8_t HCTRIM;                                  /**< MCG High Frequency IRC Coarse Trim Register, offset: 0x14 */
  uint8_t HTTRIM;                                  /**< MCG High Frequency IRC Tempco Trim Register, offset: 0x15 */
  uint8_t HFTRIM;                                  /**< MCG High Frequency IRC Fine Trim Register, offset: 0x16 */
  uint8_t RESERVED_3[1];
  uint8_t MC;                                      /**< MCG Misc Control Register, offset: 0x18 */
  uint8_t LTRIMRNG;                                /**< MCG Low Frequency IRC Trim Range Register, offset: 0x19 */
  uint8_t LFTRIM;                                  /**< MCG Low Frequency IRC8M Trim Register, offset: 0x1A */
  uint8_t LSTRIM;                                  /**< MCG Low Frequency IRC2M Trim Register, offset: 0x1B */
...
#define MCG_HCTRIM                               MCG_HCTRIM_REG(MCG_BASE_PTR)
#define MCG_HTTRIM                               MCG_HTTRIM_REG(MCG_BASE_PTR)
#define MCG_HFTRIM                               MCG_HFTRIM_REG(MCG_BASE_PTR)
#define MCG_MC                                   MCG_MC_REG(MCG_BASE_PTR)
#define MCG_LTRIMRNG                             MCG_LTRIMRNG_REG(MCG_BASE_PTR)
#define MCG_LFTRIM                               MCG_LFTRIM_REG(MCG_BASE_PTR)
#define MCG_LSTRIM                               MCG_LSTRIM_REG(MCG_BASE_PTR)
