...
#define VECTOR_061      default_isr     // 0x0000_00F4 61    45     SCI0            Single interrupt vector for SCI status sources
#define VECTOR_062      default_isr     // 0x0000_00F8 62    46     SCI0            Single interrupt vector for SCI error sources
#define VECTOR_063      default_isr     // 0x0000_00FC 63    47     SCI1            Single interrupt vector for SCI status sources
#define VECTOR_064      default_isr     // 0x0000_0100 64    48     SCI1            Single interrupt vector for SCI error sources
#define VECTOR_065      default_isr     // 0x0000_0104 65    49     SCI2            Single interrupt vector for SCI status sources
#define VECTOR_066      default_isr     // 0x0000_0108 66    50     SCI2            Single interrupt vector for SCI error sources
#define VECTOR_067      default_isr     // 0x0000_010C 67    51     SCI3            Single interrupt vector for SCI status sources
#define VECTOR_068      default_isr     // 0x0000_0110 68    52     SCI3            Single interrupt vector for SCI error sources
#define VECTOR_069      default_isr     // 0x0000_0114 69    53     SCI4            Single interrupt vector for SCI status sources
#define VECTOR_070      default_isr     // 0x0000_0118 70    54     SCI4            Single interrupt vector for SCI error sources
#define VECTOR_071      default_isr     // 0x0000_011C 71    55     SCI5            Single interrupt vector for SCI status sources
#define VECTOR_072      default_isr     // 0x0000_0120 72    56     SCI5            Single interrupt vector for SCI error sources
