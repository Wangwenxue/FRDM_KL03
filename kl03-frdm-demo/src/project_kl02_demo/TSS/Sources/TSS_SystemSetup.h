...
#define TSS_KINETIS_MCU                        1  // or add define MCU_MKL02Z4 in TSS_Sensor.h to detecte the mcu
...
// for GPIO method, TPM0 and TPM2 is for PWM in app_init.c file
#ifdef TSS   // for GPIO_TSS_Demo
  #define TSS_HW_TIMER                           TPM1 //FTMx or MTIMx
#else
  #define TSS_HW_TIMER                           TPM0 //FTMx or MTIMx
#endif
